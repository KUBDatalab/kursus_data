...
meta_data %>% 
  ...
  cols_label(category_name = "Kategori") %>% 
  tab_footnote("Bemærk at kategorierne kommer fra kursustilmeldingssystemet, hvor brugen af kategorier er ret ujævn. Bemærk også at et typisk kursus har mere end en kategori.")
  
```

Da brugen af kategorier i kalendersystemet er så ujævn som den er, er vi nok
nødt til at finde en løsning.

Så - hvilke kategorier ønsker vi. 
